...
// src/config/resolveEsbuildLoaderOptions.ts
var resolveEsbuildLoaderOptions = (options = {}) => ({
  /**
...
var handleModuleJs = ({
  ...
  }).end().use("esbuild-loader").loader(require2.resolve("esbuild-loader")).options(resolveEsbuildLoaderOptions()).end();
};
